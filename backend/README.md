...
## Project Structure
    ...
    ├── react_native_basic__35875  # Django project configurations
...
1. Clone this repo and `cd react_native_basic__35875`
...
2. Clone this repo and `cd react_native_basic__35875`
